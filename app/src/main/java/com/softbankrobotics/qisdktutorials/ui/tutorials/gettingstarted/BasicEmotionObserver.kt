...
class BasicEmotionObserver {
    private val TAG = "Basic Emotion Observer"
    ...
    fun startObserving(qiContext: QiContext) {
        ...
        Log.i(TAG, "Checked humans around")
        ...
        Log.i(TAG, "Update observed emotion")

        this.humanAwareness = humanAwareness

        Log.i(TAG, "Human awareness: " + humanAwareness)
    }
    ...
    public fun notifyListener(): BasicEmotion {
